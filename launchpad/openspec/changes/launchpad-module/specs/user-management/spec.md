...
- **WHEN** a staff, teacher, or parent user calls `GET /api/tenants/{tenant_id}/users`
...
#### Scenario: Admin cannot demote themselves if last admin
...
- **WHEN** a staff, teacher, or parent user navigates to `/settings/users`
