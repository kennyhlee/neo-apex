...
export const translations: Record<Locale, Record<string, string>> = {
  'en-US': {
    ...
    'today.pipeline': 'Enrollment pipeline',
    'today.thisWeek': 'This week',
    'today.viewAll': 'View all',
    'today.unassignedLeads': 'Inquiries with no follow-up yet',
    'today.unassignedLeadsAction': 'Review',
    'today.oldestWaiting': 'Oldest waiting {n} days',
    'today.oldestWaitingOne': 'Oldest waiting 1 day',
    'today.longestWaiting': 'Longest {n} days',
    'today.longestWaitingOne': 'Longest 1 day',
    'today.unreachableLeads': 'Inquiries with no way to reach them',
    'today.unreachableLeadsDetail': 'No email or phone on file',
    'today.unreachableLeadsAction': 'Complete',
    'today.readyToEnrollDetail': 'All checks passed',
    'today.staleLeads': 'Inquiries waiting more than a week',
    'today.staleLeadsAction': 'Chase',
    'today.readyToEnroll': 'Leads ready to convert to families',
    'today.readyToEnrollAction': 'Convert',
  ...
  'zh-CN': {
    ...
    'today.thisWeek': '\u672c\u5468',
    'today.viewAll': '\u67e5\u770b\u5168\u90e8',
    'today.unassignedLeads': '\u5c1a\u672a\u8ddf\u8fdb\u7684\u54a8\u8be2',
    'today.unassignedLeadsAction': '\u67e5\u770b',
    'today.oldestWaiting': '最久已等待 {n} 天',
    'today.oldestWaitingOne': '最久已等待 1 天',
    'today.longestWaiting': '最长 {n} 天',
    'today.longestWaitingOne': '最长 1 天',
    'today.unreachableLeads': '无法联系的咨询',
    'today.unreachableLeadsDetail': '未登记邮箱或电话',
    'today.unreachableLeadsAction': '补全',
    'today.readyToEnrollDetail': '已通过全部检查',
    'today.staleLeads': '\u7b49\u5f85\u8d85\u8fc7\u4e00\u5468\u7684\u54a8\u8be2',
    'today.staleLeadsAction': '\u8ddf\u8fdb',
    'today.readyToEnroll': '\u53ef\u8f6c\u4e3a\u5bb6\u5ead\u7684\u54a8\u8be2',
    'today.readyToEnrollAction': '\u8f6c\u6362',
    'today.students': '\u5b66\u751f',
    'today.families': '\u5bb6\u5ead',
