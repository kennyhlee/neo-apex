...
/**
 * The single overlay component for the product.
 *
 * Provides what the previous 18 bespoke overlays each lacked in some
 * combination: focus trap, focus restoration on close, Escape handling scoped
 * to the topmost overlay, background scroll lock, `role="dialog"`,
 * `aria-modal`, and an `aria-labelledby` pointing at the panel's own heading.
 */
