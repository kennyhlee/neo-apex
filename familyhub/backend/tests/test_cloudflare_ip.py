# familyhub/backend/tests/test_cloudflare_ip.py
"""Tests for the Cloudflare IP allowlist middleware.

Copied (with app-specific health path already matching) from
papermite/admindash/launchpad's identical test file -- see
app/middleware/cloudflare_ip.py's own docstring for why this module is
