// Ported from admindash/frontend/src/hooks/useTranslation.ts (interface map
// §1e). Global module-level listener pattern, not React context — same
// STORAGE_KEY ('preferredLanguage') as admindash/familyhub so locale choice
// is consistent if a user crosses services in one browser.
