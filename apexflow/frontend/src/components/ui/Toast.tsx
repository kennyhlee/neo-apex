// Ported from admindash/frontend/src/components/ui/Toast.tsx (interface map §1f).
import { useCallback, useMemo, useRef, useState, type ReactNode } from 'react';
import { ToastContext, type ToastOptions, type ToastRecord } from '../../contexts/toastStore';
import './Toast.css';
...
/**
 * Toast host for the whole app. Every successful mutation reports itself;
 * destructive actions pass `onUndo` and get a ten-second Undo instead of a
 * blocking confirm where the backend supports it.
 */
