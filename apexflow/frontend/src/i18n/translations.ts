...
export const translations: Record<Locale, Record<string, string>> = {
  'en-US': {
    ...
    'editor.exit.landsOn': 'Lands on',
    'editor.exit.add': 'Add an exit',
    'editor.exit.remove': 'Remove this exit',
  ...
  'zh-CN': {
    ...
    'editor.exit.landsOn': '进入',
    'editor.exit.add': '添加退出',
    'editor.exit.remove': '删除此退出',
