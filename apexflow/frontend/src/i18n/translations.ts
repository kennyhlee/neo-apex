...
export const translations: Record<Locale, Record<string, string>> = {
  'en-US': {
    ...
    'editor.discard.button': 'Discard',
    'editor.discard.title': 'Discard this draft?',
    'editor.discard.body': 'This draft has never been published, so nothing is using it. It will be deleted and you will return to the workflow list.',
    'editor.discard.keep': 'Keep editing',
    'editor.discard.confirm': 'Discard draft',
    'editor.discard.discarding': 'Discarding…',
    'editor.discardToast': 'Draft discarded.',
    'editor.discardFailed': "Couldn't discard this draft. Please try again.",
  ...
  'zh-CN': {
    ...
    'editor.discard.button': '放弃',
    'editor.discard.title': '放弃此草稿？',
    'editor.discard.body': '此草稿从未发布，因此没有任何内容在使用它。它将被删除，并返回工作流列表。',
    'editor.discard.keep': '继续编辑',
    'editor.discard.confirm': '放弃草稿',
    'editor.discard.discarding': '正在放弃…',
    'editor.discardToast': '草稿已放弃。',
    'editor.discardFailed': '无法放弃此草稿，请重试。',
