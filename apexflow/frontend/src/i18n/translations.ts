...
export const translations: Record<Locale, Record<string, string>> = {
  'en-US': {
    ...
    'editor.machine.param.noStatesHint': 'Add states first, in the States section above.',
    'editor.machine.param.noSectionsHint': 'No declared sections yet — add one in the Steps tab.',
    'editor.machine.param.noStepsHint': 'No declared steps yet — add one in the Steps tab.',
  ...
  'zh-CN': {
    ...
    'editor.machine.param.noStatesHint': '请先在上方"状态"部分添加状态。',
    'editor.machine.param.noSectionsHint': '暂无已声明的版块 — 请在"步骤"标签页中添加。',
    'editor.machine.param.noStepsHint': '暂无已声明的步骤 — 请在"步骤"标签页中添加。',
