      ...
      <div className="login__card">
        ...
        <div className="login__footer">
          <svg width="140" height="24" viewBox="0 0 140 24" fill="none">
            ...
            <path d="M108 8L122 3L116 15L112 10L108 8Z" fill="url(#pg-pm)" stroke="#2B6DB5" strokeWidth="0.5" strokeLinejoin="round"/>
            <path d="M122 3L112 10" stroke="#2B6DB5" strokeWidth="0.5" opacity="0.25"/>
            <defs><linearGradient id="pg-pm" x1="108" y1="3" x2="118" y2="15"><stop stopColor="#7C3AED"/><stop offset="1" stopColor="#2B6DB5"/></linearGradient></defs>
          </svg>
