...
- `models/domain.py`: Entity classes (Student, Guardian, Program, etc.) with `ENTITY_CLASSES` dict for schema introspection. All extend `BaseEntity` with `custom_fields: Dict[str, Any]`.
